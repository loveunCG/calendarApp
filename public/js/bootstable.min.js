...
var $tab_en_edic = null,
    params = null,
    colsEdi = null,
    newColHtml = '<div class="action-btn"><button id="bEdit" type="button" class="" onclick="rowEdit(this);"><span class="fa fa-pencil-square-o" aria-hidden="true" > </span></button><button id="bElim" type="button" class="" onclick="rowElim(this);"><span  class="fa fa-times" aria-hidden="true"> </span></button><button id="bAcep" type="button" class="" style="display:none;" onclick="rowAcep(this);"><span class="fa fa-floppy-o" aria-hidden="true" > </span></button><button id="bCanc" type="button" class="" style="display:none;" onclick="rowCancel(this);"><span  class="fa fa-times" aria-hidden="true"> </span></button></div>',
